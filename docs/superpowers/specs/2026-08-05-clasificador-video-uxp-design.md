...
- El plugin nunca debe estar cargado en UXP Developer Tools y copiado/instalado en la carpeta de plugins al mismo tiempo: mismo identificador, dos copias, y Premiere puede tomar la equivocada. El procedimiento exacto vive en `uxp-plugin/README.md`.
